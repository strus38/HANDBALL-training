 ...
 *
 * Ce fichier est une DONNEE, pas une regle : le tableau affiche au gymnase,
 * recopie une fois pour toutes. Tout ce que l'application en tire — la date de
 * la prochaine seance, la duree du creneau, l'espace disponible — se deduit de
 * ces dix-sept lignes, et se corrige en les modifiant.
 *
 * Trois choses s'y lisent, qui n'existaient nulle part ailleurs :
 *
